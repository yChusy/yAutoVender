...
public class PreAction {
	...
	public PreAction(Player player, String message) throws ClassNotFoundException {
		try {
			Object chatComponentText = getNMSClass("ChatComponentText").getConstructor(new Class[] { String.class })
					.newInstance(message);
			...
			Object packetPlayOutChat = getNMSClass("PacketPlayOutChat")
					...
					.newInstance(chatComponentText, chatMessageType, player.getUniqueId());
